...
//       id: `listing-${Date.now()}`, // Generate a unique ID
...
//     let inputData = { pendingListings: [] }

//     try {
//       const fileContent = await fs.readFile(inputPath, "utf8")
//       inputData = JSON.parse(fileContent)
//     } catch (error) {
//       // File doesn't exist or is empty, we'll create it
//       console.error("Error reading input.json:", error)
//     }

//     inputData.pendingListings.push(newListing)
